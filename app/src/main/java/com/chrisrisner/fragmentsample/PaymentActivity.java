...
public class PaymentActivity extends AppCompatActivity {
    ...
    String url = "http://10.120.39.94:3000/";
    final String get_token = url+"client_token/";
    final String send_payment_details = url+"checkout/";
    String token, amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price = intent.getIntExtra("Price",35);
    ...
    private void sendPaymentDetails()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, send_payment_details,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        else Toast.makeText(PaymentActivity.this, "Transaction successful", Toast.LENGTH_LONG).show();
        ...
        Log.e("mylog",String.valueOf(stringRequest));
