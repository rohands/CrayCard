...
public class FragmentOne extends Fragment {
    ...
    private void prepareAlbums() {
        int[] covers = new int[]{
                R.drawable.food,  //0
                R.drawable.tech, //1
                R.drawable.shopping, //2
                R.drawable.travel, //3
                R.drawable.shopping2, //4
                R.drawable.travel2, //5
                R.drawable.food2, //6
                R.drawable.tech2, //7
        };

        Album a = new Album("Nishant", 45, covers[0]);
        albumList.add(a);

        a = new Album("Rohan", 75, covers[1]);
        albumList.add(a);

        a = new Album("Aishwarya", 10, covers[2]);
        albumList.add(a);

        a = new Album("Saimeera", 180, covers[3]);
        albumList.add(a);

        a = new Album("Kunal", 300, covers[4]); //shopping
        albumList.add(a);

        a = new Album("Namana", 25, covers[5]);
        albumList.add(a);

        a = new Album("Prithvi", 65, covers[6]);
        albumList.add(a);

        a = new Album("Shiva", 85, covers[7]);
        albumList.add(a);
